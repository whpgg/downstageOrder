<template>
    ...
    <div id="start">
        ...
        <div v-show='showLoading'>
            <img src="../assets/images/load.gif" class="middle">
        </div>
         ...
         <div  class="start_content" v-show="!showLoading">			
                ...
                <p class="notice">请选择正确的用餐人数 ，服务员马上给你送餐具</p>
    ...
    methods: {
        addChangeEnvet () {
            ...
            for (var i = 0; i < userLis.length; i++) {
                ...
                this.className = 'active' // this 就是li
...
<style lang="scss">
.middle{
        width:10rem;height:10rem;position:absolute;top:50%;left:50%;margin-left:-5rem;margin-top:-5rem;
}
.start_content{
